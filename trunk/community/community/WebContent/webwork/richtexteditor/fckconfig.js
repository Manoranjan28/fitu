...
FCKConfig.ToolbarSets["Simple"] = [
	...
	['SelectAll'],
	'/',
	['Undo','Redo','-','Cut','Copy','Paste','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Outdent','Indent'],
	['Link','Unlink','-','Image','Flash','Table','Rule','Smiley','-','Templates']
] ;
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=File&Connector=connectors/jsp/connector.fitu' ;
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.7 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
//FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?&Type=Image&Connector=connectors/jsp/connector.fitu';
FCKConfig.ImageBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
//FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/jsp/connector.fitu';
...
FCKConfig.LinkUploadURL = FCKConfig.BasePath + 'filemanager/upload/uploader.action?Type=File' ;
...
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/upload/uploader.action?Type=Image';
...
FCKConfig.FlashUploadURL = FCKConfig.BasePath + 'filemanager/upload/uploader.action?Type=Flash';
